...
- **Ready stock:** produk yang sudah jadi dan bisa langsung dibawa pulang
- **Indent/custom:** produk yang dibuat berdasarkan pesanan, dengan spesifikasi yang mungkin berbeda dari yang ada di showroom
...
### Pencatatan Pesanan yang Detail

Setiap pesanan indent harus dicatat dengan sangat detail:
- Nama dan kontak pelanggan
- Alamat pengiriman
- Jenis furnitur yang dipesan
- Spesifikasi: ukuran, material, warna/finishing, desain
- Harga yang disepakati
- DP yang dibayar
- Estimasi waktu selesai
- Tanggal pengiriman yang direncanakan

### Konfirmasi Pesanan Tertulis
...
Jangan tunggu pelanggan menanyakan status pesanan mereka. Kirim update secara proaktif di setiap tahap penting:
- Saat produksi dimulai
- Saat produksi selesai
- Saat jadwal pengiriman sudah ditentukan

Pelanggan yang mendapat update proaktif jauh lebih sabar dan puas dibanding yang harus terus menanyakan sendiri.

## Tracking Produksi

### Koordinasi dengan Workshop/Pabrik

Jika produksi dilakukan di workshop sendiri atau di pabrik mitra, pastikan ada sistem komunikasi yang baik:
- Pesanan apa yang sedang dalam antrian
- Pesanan mana yang sedang dikerjakan
- Estimasi waktu selesai untuk setiap pesanan

### Monitoring Kapasitas Produksi

Pantau kapasitas produksi secara berkala:
- Berapa pesanan yang sedang dalam proses?
- Berapa kapasitas maksimum per minggu?
- Apakah ada bottleneck di proses tertentu?

Informasi ini penting untuk memberikan estimasi waktu yang akurat kepada pelanggan baru.

### Manajemen Bahan Baku

Produksi furnitur membutuhkan berbagai bahan baku: kayu, kain, busa, hardware (engsel, rel laci, dll.). Pastikan stok bahan baku selalu tersedia untuk menghindari keterlambatan produksi.

## Manajemen Showroom

### Display yang Efektif

Showroom furnitur harus menampilkan produk dengan cara yang membantu pelanggan membayangkan bagaimana furnitur tersebut akan terlihat di rumah mereka:
- Tata ruang yang realistis
- Pencahayaan yang baik
- Kombinasi produk yang harmonis
...
Sediakan sampel material (kain, kayu, finishing) yang bisa dipegang dan dibawa pulang oleh pelanggan. Ini membantu mereka membuat keputusan yang lebih yakin.

## Manajemen Pengiriman

### Jadwal Pengiriman yang Terstruktur

Buat jadwal pengiriman yang terstruktur berdasarkan area:
- Senin: area A
- Selasa: area B
- dst.

Ini mengoptimalkan rute dan mengurangi biaya pengiriman.

### Konfirmasi Sebelum Pengiriman

Konfirmasi kepada pelanggan 1-2 hari sebelum pengiriman:
- Tanggal dan estimasi waktu pengiriman
- Pastikan ada orang di rumah untuk menerima
- Konfirmasi akses (apakah ada tangga, lift, dll.)

### Instalasi dan After-sales

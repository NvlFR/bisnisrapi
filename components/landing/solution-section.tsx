...
const features = [
  { title: "Pantau Bisnis Kapan Saja", description: "Cek angka penjualan, pengeluaran, dan performa tim detik ini juga. Tidak perlu tanya staf." },
  { title: "Admin Berjalan Otomatis", description: "Biarkan sistem yang kirim kuitansi, update stok, dan rekap laporan. Hemat waktu & tenaga." },
  { title: "Stok Akurat 100%", description: "Setiap barang masuk dan keluar tercatat otomatis dengan validasi ketat. Hilangkan kebocoran stok." },
  { title: "Kontrol Lewat HP", description: "Pantau bisnis sambil liburan atau dari luar kota. Semua data penting ada di genggaman Anda." },
  { title: "Sistem Ikuti Alur Anda", description: "Kami bangun sistem mengikuti cara Anda bekerja, bukan memaksa Anda pakai template kaku." },
];
      ...
      <div className="relative max-w-[1440px] 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-[1.2] tracking-tight text-balance">
            Sistem Manajemen yang <br className="lg:hidden" /> <span style={{
              background: 'linear-gradient(to right, #59f6e3, #185cf8)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
          ...
          <p className="mt-5 text-base text-muted-foreground leading-relaxed font-medium">
            Kami membangun sistem kustom yang membuat operasional Anda lebih rapi, efisien, dan mudah dikontrol.
          </p>
        </m.div>
